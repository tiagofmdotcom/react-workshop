...
- Time to install React Testing Library: `yarn add --dev @testing-library/react @testing-library/jest-dom jest ts-jest @types/jest jest-environment-jsdom`
...
- Lets create a story for the contact card component:
```jsx
